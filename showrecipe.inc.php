<?php
$con = mysqli_connect("localhost", "test", "") or die('Could not connect to server ');
...
$result = mysqli_query($query) or die('Could not find recipe');
...
} else
{
   ...
   $result = mysqli_query($query) or die('Could not retrieve comments: ' . mysql_error());
